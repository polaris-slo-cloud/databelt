...
```bash
docker buildx build --platform wasi/wasm  --provenance=false -t guelmino/skylark-ex-bundled:0.2.902 .
docker push guelmino/skylark-ex-bundled:0.2.902
```
### Deploy
```bash
...
curl -v http://pi5u2-bundled.default.svc.cluster.local/get-and-set?policy=Serverless\&destination=pi5u2\&key=0c10e7a2-4b6f-4167-a5cd-2540d6d4b5f2\:9adc8480-60f5-4efc-a85c-cd32d4c99b61
