...
curl -v http://10.152.183.251/?policy=Skylark\&destination=pi5u1\&img=eo-2K.jpeg -H "Host: pi5u4-write-data.default.svc.cluster.local"
curl -v http://10.0.0.34:8084/single?destination=pi5u3&size=10000
curl -v http://10.152.183.251/health -H "Host: pi5u4-write-data.default.svc.cluster.local"
