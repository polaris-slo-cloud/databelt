...
FUNC1_URL="http://10.152.183.86/?policy=Skylark\&destination=pi5u1\&img=eo-$1.jpeg"
FUNC1_HEADER="Host: pi5u2-preprocess.default.svc.cluster.local"
FUNC2_URL="http://10.152.183.86/?policy=Skylark\&destination=pi5u1\&key="
FUNC2_HEADER="Host: pi5u4-detect.default.svc.cluster.local"
FUNC3_URL="http://10.152.183.86/?policy=Skylark\&destination=pi5u1\&key="
FUNC3_HEADER="Host: pi4u5-detect.default.svc.cluster.local"
FUNC4_URL="http://10.152.183.86/?policy=Skylark\&destination=pi5u1\&key="
