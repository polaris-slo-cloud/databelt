...
pub fn skylark_manage_version() -> &'static str {
...
pub async fn store_single_state(
    ...
    debug!("store_single_state: calling skylark elect");
...
pub async fn store_bundled_state(
    ...
    debug!("store_bundled_state: calling skylark elect");
    let data_size = final_state.len();
